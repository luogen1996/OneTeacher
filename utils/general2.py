...
def non_max_suppression_pseudo(prediction, conf_thres=0.25,cls_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    xc = (prediction[..., 4] > conf_thres) * (prediction[..., 5:].max(-1)[0] > cls_thres)  # candidates
